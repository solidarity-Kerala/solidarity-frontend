...
const AimOfProgram = (props) => {
  //to update the page title
  useEffect(() => {
    document.title = `AimOfProgram  - Diet Food Management Portal`;
  }, []);

  const [attributes] = useState([
    {
      type: "text",
      placeholder: "Aim Of Program Name",
      name: "aimofProgramName",
      validation: "",
      default: "",
      tag: false,
      label: "Aim Of Program Name",
      required: true,
      view: true,
      add: true,
      update: true,
...
export default Layout(AimOfProgram);
