...
const Patient = (props) => {
  ...
  const [dietaryRecord] = useState([
    ...
    },
    {
      ...
      placeholder: "Food Dislike Category",
      name: "foodDisLikeList",
      validation: "",
      showItem: "proteinCategoriesName",
      default: "",
      tag: true,
      label: "Food Dislike Category",
      required: false,
      view: true,
      add: true,
      update: true,
    ...
    },
    {
      type: "multiSelect",
      apiType: "API",
      selectApi: "ingredient/get-ingredient-by-ingredientGroup",
      updateOn: "foodDisLikeList",
      placeholder: "Ingredient List",
      name: "ingredientList",
      validation: "",
      params: [{id: "ingredientList", value: "", dynamic:true}],
