    ...
    const response = await putData(
      {
        ...
        quantity: ingredientTest[index].quantity ?? 1,
      },
      "recipe-ingredients"
    );
    setNutritionInfo(response.data.recipeNutritionInfo);
  ...
  return (
    <ColumnContainer className="custom">
      <RowContainer className="quarter">
        <FormInput customClass="menu open" animation={`sub-1`} placeholder={"Search Ingredient"} key={1} id={0} error={null} value={search} {...mealIngredient} onChange={addIngredient} />
      </RowContainer>
      <RowContainer>
        {ingredients ? (
          <Table>
                      ...
                      <>
                        <TableCell className="padding left">
                          ...
                          <DataItemContainer className="nowrp">
                            ...
                            <DataItem>
                              {((item.ingredient.calories * item.ingredient.gramOfType) / 100)?.toFixed(2)}
                              KCal
                            </DataItem>
