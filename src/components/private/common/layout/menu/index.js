            ...
            {menuItem.submenus.length > 0 ? (
              <React.Fragment>
                <MenuGroup
                  ...
                  className={
                    openedMenus[menuItem._id] === true ? "open active" : " open"
                  }
                >
                ...
                <SubMenu
                  className={
                    openedMenus[menuItem._id] === true ? "down" : "close"
                  }
                >
              ...
              <Link
                ...
                className={
                  menuItem._id === selectedMenuItem._id ? "main active" : "main"
                }
                to={menuItem.path}
              >
