  ...
  return (
    <SelectBox key={props.key} theme={props.theme} className={`custom-select ${props.listBox ? "list-box" : ""} ${optionsVisible ? "open" : "close"} ${props.customClass} ${props.dynamicClass}`} ref={selectRef}>
      ...
      <ul className="options">
        ...
        {props.apiSearch && <Search key="search-api-2" className={"select "+props.customClass} title="Search" theme={props.theme} placeholder="Search" value={searchKey} onChange={handleChange} />}
